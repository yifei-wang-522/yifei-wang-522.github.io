...
function toggleLoading(isLoading) {
  ...
  if(isLoading === true){
    item = document.getElementById("s_button");
    item2 = document.getElementById("search_icon");
    item2.remove();
    item.innerHTML = '<i id="search_icon" class="fas fa-hourglass-half"></i> Loading...';
    item.disabled = true;
  }else{
    item = document.getElementById("s_button");
    item2 = document.getElementById("search_icon");
    item2.remove();
    item.innerHTML = '<i id="search_icon" class="fa fa-search"></i> Search';
    item.disabled = false;
  }
